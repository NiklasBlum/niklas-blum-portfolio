...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 py-6 sm:py-8 px-4 sm:px-6 md:px-8 border-t border-gray-200 dark:border-gray-700">
